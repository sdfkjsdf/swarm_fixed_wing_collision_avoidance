...
PRODUCTION_SHARE=$(ros2 pkg prefix --share collision_avoidance)
ROS_PARAMS_FILE=${ROS_PARAMS_FILE:-${PRODUCTION_SHARE}/config/ros_params.yaml}
...
for i in $(seq 0 $((NUM_VEHICLES-1))); do
    ...
    "${PX4_PYTHON_BIN}" $src_path/Tools/simulation/gazebo-classic/sitl_gazebo-classic/scripts/jinja_gen.py \
