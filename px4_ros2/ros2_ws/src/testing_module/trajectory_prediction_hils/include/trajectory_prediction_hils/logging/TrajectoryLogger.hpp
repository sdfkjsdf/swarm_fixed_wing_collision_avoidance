...
public:
    ...
    using PredictedTrajectory =
        std::array<collision_avoidance::estimation::PredictState, kPredictHorizon>;
    ...
    using SplineTrajectory =
        std::array<collision_avoidance::estimation::PoseVel, kPredictHorizon>;
...
private:
    ...
    collision_avoidance::estimation::ReconstructTrajectory m_reconstructor_mt;
