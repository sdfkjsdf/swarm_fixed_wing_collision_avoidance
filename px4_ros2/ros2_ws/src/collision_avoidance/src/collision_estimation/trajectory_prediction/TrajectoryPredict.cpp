/* ════════════════════════════════════════════════════════════════════
   ...
   2026-05-13 마이그레이션: trajectory_prediction 패키지에서 본 위치로 이동.
     ...
     - 현재: collision_avoidance/src/collision_estimation/trajectory_prediction/TrajectoryPredict.cpp
     - namespace: trajectory_prediction → collision_avoidance::collision_estimation
