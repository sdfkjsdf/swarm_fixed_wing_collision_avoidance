...
#include <trajectory_prediction/spsc_queue.hpp>
...
/* ★ 2026-05-13 마이그레이션: PredictState/Input/Params 정의는 본 파일에서 제거.
   ...
   (trajectory_prediction:: → collision_avoidance::collision_estimation::).
   *튜닝 인프라 타입* (FwSetpointOutput_rt2mt) 는 trajectory_prediction:: 그대로 유지. */
#include <collision_avoidance/collision_estimation/trajectory_prediction/PredictTypes.hpp>

/* ═══════════════════════════════════════════════════════════════
   trajectory_prediction 전용 StateType
   collision_avoidance/StateType.hpp 발췌 — 1대용이라 InputQueue / AgentState 불필요.
...
/* ═══════════════════════════════════════════════════════════════
   ...
   collision_avoidance::collision_estimation library (PredictTypes.hpp) 가
   *유일한 source of truth*. 본 파일 상단의 #include 가 그 헤더 가져옴.
   ...
   collision_avoidance::collision_estimation:: 으로 사용 (sed 일괄 치환 완료).
   ═══════════════════════════════════════════════════════════════ */
