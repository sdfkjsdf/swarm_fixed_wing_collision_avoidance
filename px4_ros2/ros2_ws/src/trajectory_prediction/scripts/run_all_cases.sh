...
CASE_DIR="${ROS2_WS}/src/trajectory_prediction/config/cases"
RESULTS_DIR="${ROS2_WS}/results/cases"
LAUNCH_SCRIPT="${ROS2_WS}/src/trajectory_prediction/scripts/launch_1vtol_replay.sh"
...
echo ""
echo "[runner] 분석 명령:"
echo "  /home/leedonghyuck/anaconda3/bin/python3 \\"
echo "      ${ROS2_WS}/src/trajectory_prediction/scripts/analyze_cases.py \\"
