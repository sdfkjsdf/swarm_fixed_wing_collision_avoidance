...
try:
    ...
    sys.exit('ERROR: scipy 필요. /home/leedonghyuck/anaconda3/bin/python3 사용 권장.')
...
def main():
    ...
    p.add_argument('--results',  default='/home/leedonghyuck/ros2_ws/results/cases',
                   help='case CSV 디렉토리 (default: results/cases/)')
    p.add_argument('--matrix',
                   default='/home/leedonghyuck/ros2_ws/src/trajectory_prediction/config/case_matrix.yaml',
                   help='case_matrix.yaml 경로')
    p.add_argument('--out-dir', default='/home/leedonghyuck/ros2_ws/results',
                   help='plot + 보고서 출력 디렉토리')
