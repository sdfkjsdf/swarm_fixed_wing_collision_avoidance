...
const FixedwingSpec_t g_FixedwingSpec = {
     ...
     .max_roll  = DEG_TO_RAD(35.0),  /* 최대 허용 롤각 선언 */ 
     .min_roll  = -DEG_TO_RAD(35.0),  /* 최소 허용 롤각 선언 */ 
     .max_pitch = DEG_TO_RAD(18.0), /* 최대 허용 피치각 선언 */ 
     .min_pitch = -DEG_TO_RAD(12.0), /* 최소 허용 피치각 선언 */ 
     .timeconstant_p = 0.5,
     .timeconstant_q = 0.6,
     .timeconstant_r = 0.8,
     .timeconstant_at =1.0,
     .p_max =  DEG_TO_RAD(70),      /* 최대 roll rate */ 
     .p_min = -DEG_TO_RAD(70),      /* 최소 roll rate */ 
     .q_max =  DEG_TO_RAD(45),      /* 최대 pitch rate*/ 
     .q_min = -DEG_TO_RAD(45),      /* 최소 pitch rate */ 
     .r_max =  DEG_TO_RAD(25),      /* 최대 yaw rate */ 
     .r_min = -DEG_TO_RAD(25),      /* 최소 yaw rate */ 
     .at_max = 4.0,                   /* 최대 T/m 즉 중량 대 추력비  */ 
     .at_min = 0.0,     
     .g = 9.81,                     /*중력 가속도를 의미 */
     .k_acc = 0.002   /*항력 계수를 의미*/
