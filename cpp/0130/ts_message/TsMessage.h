 ...
 void generate_ts_message(int const sender_index,
    ...
    {   
     ...
     void print() const {
        ...
        std::cout << " Position (N, E, D) : (" << m_ts_north << ", " << m_ts_east << ", " << m_ts_down << ") m" << std::endl;
        
        // ts_south_speed는 정의되어 있지 않으므로 m_ts_east_speed로 수정 (또는 논리에 맞게 수정)
        std::cout << " Velocity (N, E, D) : (" << m_ts_north_speed << ", " << m_ts_east_speed << ", " << m_ts_down_speed << ") m/s" << std::endl;
